      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <Link
              to="https://x.com/samyak3313?t=7mPcWEi8xK1jxk3V2Sr3ig&s=09"
              target="_blank"
            ...
            <Link
              to="https://www.instagram.com/samyakjain378?igsh=MXY0eXB1MzAwYXpwcg=="
              target="_blank"
              className="hover:text-gray-400"
            >
            ...
            <Link
              to="https://github.com/Samyakjain808"
              target="_blank"
              className="hover:text-gray-400"
            >
